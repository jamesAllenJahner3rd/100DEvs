...
//make express easier to use
const app = express()
// get mongoClient library
const MongoClient = require('mongodb').MongoClient
// hard code a port number
const PORT = 2121
// allows you to use load environment variables to hide sensitive data
require('dotenv').config()

//creates 3 variables and assigns 2 of them 
let db,
